...
var (
	...
	c              = channel.NotifChannel_ChannelEmail
	req            = npool.SendStateReq{
		ID:             &id,
		AppID:          &appID,
		UserID:         &userID,
...
func createBulk(t *testing.T) {
	...
	for _, _amt := range entities {
		...
		_c := channel.NotifChannel_ChannelEmail
		reqs = append(reqs, &npool.SendStateReq{
			ID:             &_id,
			AppID:          &_appID,
			UserID:         &_userID,
