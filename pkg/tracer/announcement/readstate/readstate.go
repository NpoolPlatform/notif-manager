...
func trace(span trace1.Span, in *npool.ReadStateReq, index int) trace1.Span {
	span.SetAttributes(
...
func Trace(span trace1.Span, in *npool.ReadStateReq) trace1.Span {
...
func TraceMany(span trace1.Span, infos []*npool.ReadStateReq) trace1.Span {
