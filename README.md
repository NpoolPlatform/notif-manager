...
[![Test](https://github.com/NpoolPlatform/notif-manager/actions/workflows/main.yml/badge.svg?branch=master)](https://github.com/NpoolPlatform/notif-manager/actions/workflows/main.yml)
...
* make notif-manager ```单独编译服务```
* make notif-manager-image ```单独生成服务镜像```
